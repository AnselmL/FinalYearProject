...
out_base_dir = 'E:\FYP\ML_data_dir\directional\simulated\10-fold_2021_04_10';
    ...
    %}
        ...
        if direc_on(direc_index) == 1
            ...
            elseif direc_type(direc_type_index) == 1
                ...
                fprintf(fileID,strcat(strrep(strcat('directory of speech file used: ',TIMIT_wav_dirs{direc_file_index}),'\','/'),' \n'));
            end
        end
