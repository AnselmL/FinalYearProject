...
def mat_to_tfrecord(mat_dir_feat_train):
    ...
    tfrecord_dir = '/home/al5517/ML_data/directional_2021_06_02/tfrecord/OtOBmag_gddiff/'
...
def tfrecord_to_dataset(nfeatures, nb_frames, tfrecord_fname, batch_size, shuffle_buffer):
    ...
    tfrecord_dir = '/home/al5517/ML_data/directional_2021_06_02/tfrecord/OtOBmag_gd/'
