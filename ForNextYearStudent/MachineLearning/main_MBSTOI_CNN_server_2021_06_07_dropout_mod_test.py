...
from build_model_MBSTOI_CNN_features_2021_06_13 import *
...
if __name__ == "__main__":
    ...
    iteration = 0
    file_iter = 1
    base_dir = '/home/al5517/ML_data/directional_2021_06_02/parameter_testing/dropout_mod_upd'
    ...
    dropout_values = [0.3, 0.4, 0.5, 0.6] #old [0,0.0625,0.1,0.125,0.2]
    #dropout_values = [0.25, 0.3, 0.375, 0.4]
    max_pool_bool = [False]
                   ...
                   for fc_3_neurons in third_fc_neurons:
                        for act_fun in act_func:
                          ...
                          #                  for i in range(0,2):
                                                ...
                                                model = build_model(OPTIMIZER, LOSS, METRICS, layer_size, kernel_size, nfeatures, nb_frames, dropout_val) #used to be 36, 3,3
                                                model.summary()
