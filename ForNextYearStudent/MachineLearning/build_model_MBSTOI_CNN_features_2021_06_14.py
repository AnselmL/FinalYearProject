...
def build_model(optimizer, loss, metrics, KernelSize1, input_dim1, input_dim2):
    ...
    model.add(tf.keras.layers.Conv2D(8, KernelSize1, strides=(1,1), activation='selu', input_shape=(input_dim1, input_dim2, 2)))
    model.add(tf.keras.layers.BatchNormalization())
    model.add(tf.keras.layers.AveragePooling2D(
        pool_size=(1, 8), strides=None, padding='valid', data_format=None))
    #if pool_max == True:
