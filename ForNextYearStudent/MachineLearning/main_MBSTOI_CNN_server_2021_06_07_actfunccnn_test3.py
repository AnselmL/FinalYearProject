...
if __name__ == "__main__":
    ...
    data_dir = '/home/al5517/ML_data/directional_2021_06_02/parameter_testing/act_funccnn2/'
               ...
               for fc_2_neurons in second_fc_neurons:
                    for act_fun in act_func:
                      ...
                      #                  for i in range(0,2):
                                            ...
                                            model.save_weights(f'{data_dir}{iteration+9}/model_weights_2fold')
                                            ...
                                            sio.savemat(f'{data_dir}{iteration+9}/predictions_data.mat',
                                                        results_data)
