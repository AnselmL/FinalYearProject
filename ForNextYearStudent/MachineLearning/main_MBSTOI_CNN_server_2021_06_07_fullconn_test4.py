...
from build_model_MBSTOI_CNN_fullconn_2021_06_08 import *
...
if __name__ == "__main__":
    ...
    iteration = 9
    file_iter = 1
    base_dir = '/home/al5517/ML_data/directional_2021_06_02/parameter_testing/fullconn_mod_upd'
    ...
    niterations = len(cnn_layer_size)
    #iteration = 10
                   ...
                   for fc_3_neurons in third_fc_neurons:
                        for act_fun in act_func:
                          ...
                          #                  for i in range(0,2):
                                                ...
                                                model = build_model(OPTIMIZER, LOSS, METRICS, layer_size, kernel_size, nfeatures, nb_frames, act_fun, dropout_val, fc_1_neurons, fc_2_neurons, fc_3_neurons, nb_fc) #used to be 36, 3,3
                                                model.summary()
