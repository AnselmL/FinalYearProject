...
def mat_to_tfrecord(mat_dir_feat_train):
    ...
    tfrecord_dir = '/home/al5517/ML_data/directional_2021_06_02/tfrecord/stftmag/'
...
def nparray_to_tfrecord(mat_dir_feat, subdirs, tfrecrod_fname):
    ...
    def load_mat_features(fname):
        ...
        cl_mag = mat_contents['xl_hat_mag']
        #cl_phase = mat_contents['xl_lf_phase_norm']
        cr_mag = mat_contents['xr_hat_mag']
        #cr_phase = mat_contents['xr_lf_phase_norm']
        dl_mag = mat_contents['yl_hat_mag']
        #dl_phase = mat_contents['yl_lf_phase_norm']
        dr_mag = mat_contents['yr_hat_mag']
    ...
    #total_frames = 0
    mat_fname_features = mat_dir_feat + subdirs[0] + '/stft_mag.mat'
    ...
    for idx in range(len(subdirs)):
        mat_fname_features = mat_dir_feat + subdirs[idx] + '/stft_mag.mat'
