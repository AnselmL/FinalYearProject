...
def mat_to_tfrecord(mat_dir_feat_train):
    ...
    if not(os.path.isfile('/home/al5517/ML_data/directional_2021_06_02/labels_val_recon_online.mat')):
        ...
        val_idx = mat_contents_val_idx['labels_val_recon']
        val_idx = val_idx.flatten()
    tfrecord_dir = '/home/al5517/ML_data/directional_2021_06_02/tfrecord/stftmag_tf_online/'
...
def nparray_to_tfrecord(mat_dir_feat, subdirs, tfrecrod_fname):
    ...
    def load_mat_features(fname_mag, fname_phase, fname_H):
        ...
        C = np.empty((cl_mag.shape[0] + cl_mag.shape[0], cl_mag.shape[1]), dtype=cl_mag.dtype)
        C[0::2, :] = cl_mag
        #C[1::4, :] = cl_phase
        C[1::2, :] = cr_mag
        #C[3::4, :] = cr_phase
        ...
        D = np.empty((dl_mag.shape[0] + dl_mag.shape[0], dl_mag.shape[1]), dtype=dl_mag.dtype)
        D[0::2, :] = dl_mag
        #D[1::4, :] = dl_phase
        D[1::2, :] = dr_mag
        #D[3::4, :] = dr_phase
