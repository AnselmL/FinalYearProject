...
def mat_to_tfrecord(mat_dir_feat_train):
    ...
    tfrecord_dir = '/home/al5517/ML_data/directional_2021_06_02/tfrecord/OtOBmag/'
...
def nparray_to_tfrecord(mat_dir_feat, subdirs, tfrecrod_fname):
    ...
    def load_mat_features(fname_mag, fname_phase, fname_H):
        ...
        C = np.empty((2 * cl_mag.shape[0], cl_mag.shape[1]), dtype=cl_mag.dtype)
        ...
        D = np.empty((2*dl_mag.shape[0], dl_mag.shape[1]), dtype=dl_mag.dtype)
