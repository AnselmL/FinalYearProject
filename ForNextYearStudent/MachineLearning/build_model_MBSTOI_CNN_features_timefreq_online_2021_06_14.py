...
def custom_activation(x):
    return (tf.keras.backend.sigmoid(x) * 1.4) - 0.4
...
def build_model(optimizer, loss, metrics, KernelSize1, StrideConv, KernelSizePool,input_dim1, input_dim2):
    ...
    model.add(tf.keras.layers.Conv2D(3, KernelSize1, strides=StrideConv, activation='selu', input_shape=(input_dim1, input_dim2, 2)))
