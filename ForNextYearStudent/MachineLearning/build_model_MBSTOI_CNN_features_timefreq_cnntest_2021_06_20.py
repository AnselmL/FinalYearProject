...
def build_model(optimizer, loss, metrics, FilterSize1, KernelSize1, StrideConv, KernelSizePool,input_dim1, input_dim2):
    ...
    model.add(tf.keras.layers.Conv2D(FilterSize1, KernelSize1, strides=StrideConv, activation='selu', input_shape=(input_dim1, input_dim2, 2)))
