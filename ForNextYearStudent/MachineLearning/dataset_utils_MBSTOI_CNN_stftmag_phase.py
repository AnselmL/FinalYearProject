...
def mat_to_tfrecord(mat_dir_feat_train, save_dir, val_size):
    """
    ...
    tfrecord_dir = '/home/al5517/ML_data/directional_2021_06_02/tfrecord/stftmag_phase/'
...
def mat_to_nparray_test(mat_dir_feat_test,save_dir):
    """
    Recursively reads a directory of mat files into one tfrecord
