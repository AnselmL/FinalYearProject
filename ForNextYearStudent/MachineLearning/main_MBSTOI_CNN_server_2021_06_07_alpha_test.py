...
from build_model_MBSTOI_CNN_2021_05_29 import *
...
if __name__ == "__main__":
    ...
    data_dir = '/home/al5517/ML_data/directional_2021_06_02/parameter_testing/alpha/cnnbn/lrs/'
    ...
    test_dataset = tfrecord_to_dataset(nfeatures, nb_frames, data_dir + 'test.tfrecord', BATCH_SIZE,
                                       SHUFFLE_BUFFER_SIZE)
    ...
    train_dataset = tfrecord_to_dataset(nfeatures, nb_frames, data_dir + 'train.tfrecord', BATCH_SIZE,
                                        SHUFFLE_BUFFER_SIZE)
    val_dataset = tfrecord_to_dataset(nfeatures, nb_frames, data_dir + 'val.tfrecord', BATCH_SIZE_VAL,
                                       SHUFFLE_BUFFER_SIZE_VAL)
    niterations = len(alpha_values)
    iteration = 0
               ...
               for fc_2_neurons in second_fc_neurons:
                    for alpha_val in alpha_values:
                      ...
                      #                  for i in range(0,2):
                                            ...
                                            model = build_model(OPTIMIZER, LOSS, METRICS, layer_size, kernel_size, nfeatures, nb_frames, alpha_val, dropout_val, fc_1_neurons, fc_2_neurons) #used to be 36, 3,3
                                            model.summary()
