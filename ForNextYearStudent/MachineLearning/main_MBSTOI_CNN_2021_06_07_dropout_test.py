...
from build_model_MBSTOI_CNN_features_2021_06_10 import *
...
if __name__ == "__main__":
    mat_dir_feat_train = 'D:/FYP/feature_preprocessing_output/directional_2021_06_04/TRAIN/'

    mat_dir_feat_test = 'D:/FYP/feature_preprocessing_output/directional_2021_06_04/TEST/'
    data_dir = 'D:/FYP/ML_data/directional_2021_06_02/dropout4/'
    ...
    # if os.path.isfile(data_dir + 'test.tfrecord'):
    #     mat_contents = sio.loadmat(data_dir + 'testtf.mat')
    #     total_sentences_test = mat_contents['total_sentences_test']
    #     nfeatures = mat_contents['nfeatures']
    #     nb_frames = mat_contents['nb_frames']
    #     X_test = mat_contents['X_test']
    #     y_test = mat_contents['y_test']
    # else:
    #
    #     testtf = {
    #         'total_sentences_train': total_sentences_test,
    #         'nfeatures': nfeatures,
    #         'nb_frames': nb_frames,
    #         'X_test': X_test,
    #         'y_test': y_test
    #     }
    #     sio.savemat(f'{data_dir}testtf.mat',
    #                 testtf)
    ...
    #
    # if os.path.isfile(data_dir + 'val.tfrecord'):
    #     mat_contents = sio.loadmat(data_dir + 'trainvaltf.mat')
    #     total_sentences_train = mat_contents['total_sentences_train']
    #     total_sentences_val = mat_contents['total_sentences_val']
    #     nfeatures = mat_contents['nfeatures']
    #     nb_frames = mat_contents['nb_frames']
    ...
    #
    #     trainvaltf = {
    #         'total_sentences_train': total_sentences_train,
    #         'total_sentences_val': total_sentences_val,
    #         'nfeatures': nfeatures,
    #         'nb_frames': nb_frames,
    #         'X_val': X_val,
    #         'y_val': y_val
    #     }
    #     sio.savemat(f'{data_dir}trainvaltf.mat',
    #                 trainvaltf)
    ...
    niterations = len(dropout_values)
    #iteration = 5
        ...
        for kernel_size in cnn_kernel_size:
            ...
            for fc_1_neurons in first_fc_neurons:
               for fc_2_neurons in second_fc_neurons:
                   for fc_3_neurons in third_fc_neurons:
                        for act_fun in act_func:
                          ...
                          #                  for i in range(0,2):
                                                ...
                                                model = build_model(OPTIMIZER, LOSS, METRICS, kernel_size, nfeatures, nb_frames, dropout_val) #used to be 36, 3,3
                                                model.summary()
